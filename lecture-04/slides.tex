...
\begin{columns}
    ...
    \begin{column}{0.4\textwidth}
        \includegraphics[width=0.8\textwidth]{images/gdb.png}
        \\\scriptsize{GNU Debugger (GDB)}
    \end{column}
\end{columns}
\end{frame}
...
\begin{frame}[fragile]{Strict Input Challenge}
\begin{verbatim}
...
\end{itemize}
\begin{figure}
    \includegraphics[width=.6\textwidth]{images/state-space.png}
    \caption{State Space Challenge}
\end{figure}
\end{frame}
...
\begin{frame}[t]{Syntax-aware Feasible Command Generation}
\begin{itemize}
\scriptsize
...
\end{itemize}
\begin{figure}
    \includegraphics[width=.8\textwidth]{images/generators.png}
    \caption{Command Generators}
\end{figure}
\end{frame}

\begin{frame}[t]{Learning-based Command Generator Selection}
\begin{itemize}
        \scriptsize
...
\end{itemize}
\begin{figure}
    \includegraphics[width=.4\textwidth]{images/reinforcement-learning.png}
    \caption{Reinforcement Learning Module}
\end{figure}
\end{frame}
...
\end{itemize}
\begin{figure}
    \includegraphics[width=0.9\textwidth]{images/bugs2.png}
    \caption{Detected Bugs}
\end{figure}
\end{frame}

\begin{frame}[t]{Answer to RQ2}
\begin{itemize}
        \scriptsize
...
\end{itemize}
\begin{figure}
    \includegraphics[width=0.7\textwidth]{images/rq2.png}
    \caption{Comparison Between Baselines}
\end{figure}
\end{frame}

\begin{frame}[t]{Answer to RQ3}
\begin{itemize}
        \scriptsize
...
\end{itemize}
\begin{figure}
    \includegraphics[width=0.8\textwidth]{images/rq3.png}
